 ...
 * and console commands load automatically when their folders exist. Add this
 * attribute only to override a default — rename the module, turn a loader off,
 * or register commands that live outside a `Console` directory.
 *
 * ```php
